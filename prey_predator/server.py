...
model_params = {
    ...
    "wolf_initial_energy": Slider("Wolf initial energy", 10, 5, 20, 1),
    "sheep_initial_energy": Slider("Sheep initial energy", 10, 5, 20, 1),
    ...
    "wolf_energy_threshold": Slider("Energy threshold for wolf", 20, 5, 50, 1),
    "sheep_energy_threshold": Slider("Energy threshold for sheep", 20, 5, 50, 1),
    "grass_probability": Slider("Probability for a cell to contain grass", 0.7, 0, 1, 0.01),
    "grass": True,
